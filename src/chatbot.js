...
import './chatbot.css'; // Import the CSS file for custom styling
...
const Chatbot = () => {
    ...
    const apiKey = "enter the api key "; // Replace this with your actual API key
        ...
        try {
            const response = await axios.post(
                apiUrl,
                {
                    ...
                    model: 'gpt-3.5-turbo', // Specify the model you want to use (e.g., 'gpt-3.5-turbo')
                },
                {
                    headers: {
